...
"""
Graph Invoice Finder (v3.6.1)
תיקונים/שיפורים:
- תיקון תחביר $search: בלי מירכאות עוטפות לכל הביטוי; רק לביטויי-מפתח מדויקים.
- בדיקת קלט ל- --start-date/--end-date עם הודעות שגיאה ידידותיות.
- כולל כל השדרוגים של v3.6: אסטרטגיית עיריות/ארנונה, HTTP מותר לדומיינים ספציפיים, בונוס PDF מספרי, וכו'.
"""
...
# שים לב: אין מירכאות עוטפות לכל הביטוי; רק לביטוי מדויק.
STRATEGIES = [
    {
